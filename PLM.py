...
lottie_url = "https://assets.lottiefiles.com/packages/lf20_myejiggj.json"
animation = load_lottieurl(lottie_url)  # ✅ Fixed typo here
if animation:
    with st.sidebar:
    ...
    if search_term:
        ...
        if st.session_state.search_results:
            for book in st.session_state.search_results:
                st.write(f"**{book['title']}** by {book['author']} - {book['genre']} ({book['publication_year']})")
        else:
...
st.markdown("""
    <div class='footer'>
        <p>Created by Arsala Rana | Personal Library Manager | All rights reserved &copy; 2025</p>
    </div>
""", unsafe_allow_html=True)
